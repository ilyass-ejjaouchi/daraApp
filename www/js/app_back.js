...
.run(function($ionicPlatform,$http,$locale,$translate,$cordovaDialogs,$cordovaVibration,$ionicLoading, BackandService ,$ionicPopup, $rootScope) {
  ...
  $rootScope.domain = "http://takeawaymobileapplication.uk/visaapp/";
...
.config(function($stateProvider ,$urlRouterProvider,$translateProvider,$sceDelegateProvider,ionicDatePickerProvider,ionicTimePickerProvider, $ionicConfigProvider) {
    ...
    $translateProvider.translations('eng', {
         ...
         REPORT: 'Report',
         YOUR_REG_NUMBER: 'Your registration number',
         ...
         //Reminders Page
         DETAIL: 'Enter the details of your vehicle and the expiry dates of test certificate, tax and insurance. You will be reminded 1 week before each renewal date.',
         ...
         //Insurance Page
         REGISTRATION_NUMBER: 'Their registration number (or write cyclist/pedestrian)',
